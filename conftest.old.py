...
class ExcelReporterV2(object):
    ...
    def save_excel(self):
        ...
        infor = [self.executor, self.function, self.results.__len__(), self.success_count, self.failed_count]
        lable = ["Người thực hiện", "Chức năng", "Số test case thực hiện", "Số test case thành công", "Số test case thất bại"]
